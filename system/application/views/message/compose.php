  <style>
	.ui-autocomplete-loading { background: white url('/_design/ui-anim_basic_16x16.gif') right center no-repeat; }
	</style>

	<script>
	$(function() {
		$( "button, input:submit, a", "#compose-region-1" ).button();
		$( "a", "#compose-region-1" ).click(function() { return false; });
	});
	</script>
