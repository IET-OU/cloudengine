...
<div class="c1of2"> 
<img src="<?= site_url('image/badge/'. $badge->badge_id) ?>" alt="" style="float:left;"/>
...
<div id="region1">
        ...
        <label for="evidence_url"><?= t(
		"Evidence - please provide a single URL with evidence that you meet the criteria for this badge.") ?>
        <?php /*<input type="url" id="evidence_url" name="evidence_url" required="" size="80"
        pattern="^https?:\/\/[^\s]+$" title="A single URL starting 'http:' or 'https:'" />*/ ?>
        <?= form_url(array('name' => 'evidence_url', 'pattern' => '^https?:\/\/[^\s]+$',
          'required' => true, 'title' => t("Enter a single URL starting 'http:' or 'https:'"))) ?>
